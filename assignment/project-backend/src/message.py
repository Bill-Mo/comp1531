...
def message_send_v1(token: Union[str, bytes], ch_or_dm_id: int, message: str, to_channel: bool) -> dict:
    '''
...
def message_share_v1(token: Union[str, bytes], og_message_id: int, optional_message: str, channel_id: int, dm_id: int) -> dict:
    '''
    Given a message, update its text with new text. If the new message is an 
    empty string, the message is deleted.
...
def message_send_later_v1(token: Union[str, bytes], ch_or_dm_id: int, message: str, to_channel: bool, time_sent: int) -> dict:
    '''
    Sends a message from an authorised user to the channel/dm specified.
